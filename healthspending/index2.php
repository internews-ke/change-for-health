...
<div id="middlediv">
<div id="headericon">
<img src="healthspending/images/icons/publichealth1.png" alt="Public Health"/><img src="healthspending/images/icons/coins.png" alt="Coins"/>
</div>
<div id="selectcounty">
<h2>Please select a county:</h2>
	 ...
	 if( !isset($_SESSION['county']) )
     {
      ...
      echo '<option value="',$row['County'],'">',$row['County'],'</option>';
	   ...
	   ?>
	  <input type="submit" class="searchbutton" value="View&nbsp;&raquo;" name="search" id="search" onClick="return validate_form(this)"/>
      </div>
	  </div>
	  <?php
  ...
  if(empty($county)){
	 ...
	 exit;
	  ...
	  echo "<div id='infodiv'>";
	  $totalpopulation="<img src='healthspending/images/population.png'/>"."&nbsp;"."Total population June 2013:&nbsp;".$row['population_2013']."</br>";
	  $healthspending="<img src='healthspending/images/publichealth.png'/>"."&nbsp;"."Development health spending per person: Sh&nbsp;".number_format($row['health_spending_per_person'])."</br>";
	  $percentagehealthspending="<img src='healthspending/images/percentage.png'/>"."&nbsp;"."Development health spending over total budget:&nbsp;".$row['percentage_health_expenditure']."</br>";
      ...
      { 
	  echo "<p>";
	  $peopleplewithhiv="<img src='healthspending/images/arvs.png'/>"."&nbsp;"."People living with HIV on ARVs:&nbsp;".$row['people_living_with_hiv_on_arvs_2012']."</br>";
	  $malariacases="<img src='healthspending/images/malaria.png'/>"."&nbsp;"."Malaria cases per 100,000 people:&nbsp;".number_format($row['malaria_cases_per_100000_people_2012'])."</br>";
	  $tbprevalence="<img src='healthspending/images/tuberculosis.png'/>"."TB prevalence per 100,000 people:&nbsp;".number_format($row['TB_prevalence_per_100000 people_2012'])."</br>";
	  echo "</p>";
	  echo $peopleplewithhiv.$malariacases.$tbprevalence;
	  echo "</p>";
	  echo "</div>";
	  echo "<div id='mapholder'>";
	  echo "<img src='healthspending/images/counties/$county.png' alt='$county' align='center' class='countyimg'/>";
	  echo "</div>";
	  echo "</div>";
      }
	  $_SESSION['county']=$county;
