...
<html>
 ...
 var chart = new google.visualization.PieChart(document.getElementById('chart_div'));
      chart.draw(data, {chartArea:{left:20,top:60,width:"100%",height:"100%"},title:"Health share of development budget",hAxis: {titleTextStyle: {color: '#000'}},width: 200, height: 300,fontName:'Century Gothic'});
    }
    </script>
  </head>
